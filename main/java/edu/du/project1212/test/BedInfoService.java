...
public class BedInfoService {
    ...
    public void syncBedInfo() {
        ...
        for (EmergencyHospitalInfo hospital : hospitalData) {
            ...
            addBedInfo(bedInfoList, "응급실", hospital.getHvs01(), hospital.getHvs01(), "Critical");
            addBedInfo(bedInfoList, "소아과", hospital.getHvs03(), hospital.getHvs03(), "Moderate");
            addBedInfo(bedInfoList, "내과", hospital.getHvs04(), hospital.getHvs04(), "Mild");
    ...
    private void addBedInfo(List<BedInfo> bedInfoList, String bedType, String availableBeds, String usedBeds, String severity) {
